 ...
 * @author Andrew Post
 */
public abstract class AbstractNamedReadWriteResource<E extends Entity, C extends Object> extends AbstractReadWriteResource<E, C> {

    private final GetByNameSupport<E, C> support;

    public AbstractNamedReadWriteResource(DaoWithUniqueName<E, Long> inRoleDao) {
        super(inRoleDao);
        this.support = new GetByNameSupport<>(inRoleDao, this);
    }
    
    public AbstractNamedReadWriteResource(DaoWithUniqueName<E, Long> inRoleDao, boolean inRestricted) {
        super(inRoleDao, inRestricted);
        this.support = new GetByNameSupport<>(inRoleDao, this);
    }
