...
public class JwtFilter implements Filter {
    ...
    public static final String WHITELIST_PARAM_NAME = "JWT_WHITELIST";
    ...
    public void init(FilterConfig filterConfig) {
        ...
        String[] hostnames = filterConfig.getInitParameter(WHITELIST_PARAM_NAME).split(",");
        this.whitelist = Arrays.stream(hostnames)
                .map(h -> {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        InetAddress remoteAddress = InetAddress.getByName(request.getRemoteHost());

        if (this.whitelist.contains(remoteAddress) && authorization != null && authorization.length() > AUTH_TYPE.length()) {
